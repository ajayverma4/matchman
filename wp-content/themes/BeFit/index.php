...
<div class="homepage">
    ...
    <div class="container-fluid">
        <div class="section-3">
            ...
            <div class="georetown-section"
                style="background-image: url('<?php the_field("section_4_repeater_bg_img"); ?>');">

                <div class="container">
                    <div class="section-4-repeater">

                        <?php if (have_rows('section_4_repeater')): ?>
                        <?php while (have_rows('section_4_repeater')): the_row(); ?>
                        <div class="section_4_repeater-content">
                            <div class="row">
                                <div class="col-6">
                                    <img src="<?php the_sub_field("section_4_repeater_img"); ?>" alt="">

                                </div>
                                <div class="col-6">
                                    <div class="section-4-content">
                                        <h2> <?php the_sub_field("section_4_repeater_title"); ?></h2>

                                        <?php the_sub_field("section_4_repeater_content"); ?>

                                        <button><?php the_sub_field("section_4_repeater_button"); ?></button>
                                    </div>
                                </div>
